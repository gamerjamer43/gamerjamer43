...
Hi there! I’m a Class of '28 CS student based somewhere in NY, scripting cool things in Python, Java, and C++, and continually exploring new languages and technologies. ([github.com](https://github.com/gamerjamer43?tab=repositories))
...
## 💼 Other Skills
- **Backend & API Development:** Secure Flask backends (featuring sublibraries such as Flask-Login, Flask-SQLAlchemy, Flask-WTF), as well as RESTful API design
- **Databases:** SQLite3 (raw queries), SQLAlchemy (ORM), schema design and migrations
